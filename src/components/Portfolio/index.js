...
import './index.scss'
import S1 from '../../assets/images/reservasi.png'
import S2 from '../../assets/images/dashboard.png'
import S3 from '../../assets/images/Aditi.png'
import S4 from '../../assets/images/Realta.png'
import S5 from '../../assets/images/Quote.png'
import S6 from '../../assets/images/MitraMix.png'
      ...
      <div className="container portfolio-page">
        ...
        <div className="flexbox-portfolio">
          <div className="content-portfolio">
            ...
            <div className="layer">
              <h2>reservasi Bandar Djakarta</h2>
              <p>Reservation website for Bandar Djakarta Restaurant</p>
              <p>#Flask #ReactJS #Redux #Tailwind</p>
              <a href="https://reservasi.bandjak.com/">
                <i className="bx bx-lunk-external"></i>
              </a>
            </div>
          </div>
          <div className="content-portfolio">
            <img src={S2} alt="Logo1" />
            <div className="layer">
              <h2>Dasboard Bandar Djakarta</h2>
              <p>Dasboard website for Management Bandar Djakarta</p>
              <p>#Flask #ReactJS #Redux #Tailwind</p>
              <a href="#">
                <i className="bx bx-lunk-external"></i>
              </a>
